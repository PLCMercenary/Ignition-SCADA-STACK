...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Result-Filter', {
    ...
    oneditprepare: function () {
      ...
      datatypeLookupButton.click(function () {
...
</label> <input type='text' id='node-input-nodeId' placeholder='ns=2;s=MySwitch or ns=2;i=1234'> </div> <div 
...
for='node-input-withValueCheck'><i class='fa fa-optin-monster'></i> <span 
...
placeholder='maximum'> </div> <div class='form-row'> <label for='node-input-defaultvalue'><i class='icon-tag'></i> 
<span data-i18n='opcua-iiot-contrib.label.defaultvalue'></span></label> <input type='text' 
id='node-input-defaultvalue' placeholder='out of range value'> </div> </div> <div class='form-row'> <label 
for='node-input-topic'><i class='icon-tag'></i> <span data-i18n='node-red:common.label.topic'></span></label> <input 
type='text' id='node-input-topic' placeholder=''> </div> <div class='form-row'> <label for='node-input-name'><i 
...
for='node-input-showErrors'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.showErrors'></span>
</label> <input type='checkbox' id='node-input-showErrors' style='max-width:30px'> </div> </div> <div 
...
data-i18n='opcua-iiot-contrib.label.withPrecision'></span></label> <input type='checkbox' 
id='node-input-withPrecision' style='max-width:30px'> </div> <div class='form-row'> <label for='node-input-precision'>
<i class='icon-tag'></i> <span data-i18n='opcua-iiot-contrib.label.precision'></span></label> <input type='text' 
id='node-input-precision' placeholder='2'> </div> </div> </div> </script> <script type='text/x-red' 
data-help-name='OPCUA-IIoT-Result-Filter'> <h2>OPC UA IIoT Result Filter</h2> <p>
...
</p> <h3>Input</h3> <p>The input works with message objects from Read or Listener node.</p> <h3>Output</h3> <div> <ul> 
<li>payload (filtered and converted result) </li></ul> </div> <p>With the to fixed you can setup for Number objects.
</p> <p>With the precision you can setup for Number objects.</p> <p>
