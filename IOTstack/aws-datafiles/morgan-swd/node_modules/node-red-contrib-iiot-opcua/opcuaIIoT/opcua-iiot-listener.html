...
RED.nodes.registerType("OPCUA-IIoT-Listener",{category:"IIoT",color:"#ABCDEF",defaults:{connector:{type:"OPCUA-IIoT-Connector",required:!0},action:{value:"subscribe",required:!0},queueSize:{value:10,required:!0,validate:RED.validators.number()},name:{value:""},justValue:{value:!0},showStatusActivities:{value:!1},showErrors:{value:!1}},inputs:1,outputs:1,align:"left",icon:"opcuaiiot.png",label:function(){return this.name||"Listener"},labelStyle:function(){return this.name?"node_label_italic":""}})
</script> <script type='text/x-red' data-template-name='OPCUA-IIoT-Listener'>
 <div class='form-row'> <label for='node-input-connector'><i class='icon-tasks'></i> <span 
...
class='fa fa-tasks'></i> <span data-i18n='opcua-iiot-contrib.label.actiontype'></span></label> <select type='text' 
...
class='icon-time'></i> <span data-i18n='opcua-iiot-contrib.label.queueSize'></span></label> <input type='number' 
id='node-input-queueSize' placeholder=''> </div> <div class='form-row'> <label for='node-input-name'><i 
class='icon-tasks'></i> <span data-i18n='node-red:common.label.name'></span></label> <input type='text' 
...
Result in subscribe message:</strong> <ul> <li>payload <ul> <li>name </li><li>nodeId </li><li>value </li></ul> </li>
<li>topic </li><li>addressSpaceItems (Array) </li><li>injectType </li><li>readtype </li><li>mode (all/value) </li></ul>
 </div> <h3>Output 2</h3> <p>
That output provides the origin from node-opcua as JSON stringified. It is to stringify, otherwise Node-RED got errors and doesn't send anything.
</p> <strong>Name</strong> <p>Name in the flow of Node-RED.</p> <p>
