...
RED.nodes.registerType("OPCUA-IIoT-Response",{category:"IIoT",color:"#ABCDEF",defaults:{name:{value:""},showStatusActivities:{value:!1},showErrors:{value:!1}},inputs:1,outputs:1,align:"left",icon:"opcuaiiot.png",label:function(){return this.name||"Response"},labelStyle:function(){return this.name?"node_label_italic":""}})
...
style='max-width:30px'> </div> </script> <script type='text/x-red' data-help-name='OPCUA-IIoT-Response'>
...
</h3> <p>Output message from Read, Write, Listener, and Browser</p> <h3>Output</h3> <p>
