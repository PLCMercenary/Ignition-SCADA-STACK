...
data-i18n='opcua-iiot-contrib.label.connector'></span></label> <input type='text' id='node-input-connector'> </div> 
<div class='form-row'> <!-- AttributeId via REST --> <label for='node-input-attributeId'><i class='fa fa-tasks'></i> 
<span data-i18n='opcua-iiot-contrib.label.attributeId'></span></label> <select type='text' id='node-input-attributeId'>
...
value='130'>History</option> </select> </div> <div class='form-row'> <label for='node-input-maxAge'><i 
class='icon-random'></i> <span data-i18n='opcua-iiot-contrib.label.maxAge'></span></label> <input type='text' 
id='node-input-maxAge' placeholder='1'> </div> <div class='form-row' id='node-input-depth-row'> <label 
for='node-input-depth'><i class='icon-random'></i> <span data-i18n='opcua-iiot-contrib.label.depth'></span></label> 
<input type='text' id='node-input-depth' placeholder='1'> </div> <div class='form-row'> <label for='node-input-name'><i
...
for='node-input-parseStrings'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.parseStrings'></span>
</label> <input type='checkbox' id='node-input-parseStrings' style='max-width:30px'> </div> <div class='form-row'> 
<label style='min-width:160px' for='node-input-justValue'><i class='fa fa-th'></i> <span 
...
Please use the Result Filter node to handle the output of the Read node.</p> <div> <p>Results of request in message:
</p> <ul> <li>payload (Array/Object or String if not to parse) <ul> <li>results </li><li>nodesToRead </li></ul> </li>
<li>topic </li><li>nodetype </li><li>readtype </li><li>attributeId </li><li>
