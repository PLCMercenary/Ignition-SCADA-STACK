...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Method-Caller', {
 ...
 <div class='form-row'> <ul style='background:#fff;min-width:600px;margin-bottom:20px' id='node-input-method-tabs'>
</ul> </div> <div id='node-input-method-tabs-content' style='min-height:170px'> <div 
id='opcuaiiot-method-tab-settings' style='display:none'> <div class='form-row' style='min-width:640px'> <label 
for='node-input-connector'><i class='icon-globe'></i> <span data-i18n='opcua-iiot-contrib.label.connector'></span>
</label> <input type='text' id='node-input-connector'> </div> <div class='form-row'> <label for='node-input-objectId'>
<i class='icon-tasks'></i> <span data-i18n='opcua-iiot-contrib.label.objectId'></span></label> <input type='text' 
id='node-input-objectId' placeholder='ns=0;s=Server or ns=0;i=2253'> </div> <div class='form-row'> <label 
for='node-input-methodId'><i class='icon-tasks'></i> <span data-i18n='opcua-iiot-contrib.label.methodId'></span>
</label> <input type='text' id='node-input-methodId' placeholder='ns=4;s=Bark or ns=4;i=VendorName-Bark'> </div> <div 
class='form-row'> <label for='node-input-methodType'><i class='icon-tasks'></i> <span 
data-i18n='opcua-iiot-contrib.label.methodType'></span></label> <select type='text' id='node-input-methodType'> <option
 value='basic'>Basic</option> <option value='complex'>Complex</option> </select> </div> <div class='form-row'> <label 
for='node-input-value'><i class='icon-tag'></i> <span data-i18n='opcua-iiot-contrib.label.value'></span></label> <input
 type='text' id='node-input-value' placeholder=''> </div> <div class='form-row'> <label for='node-input-name'><i 
...
for='node-input-justValue'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.justValue'></span>
</label> <input type='checkbox' id='node-input-justValue' style='max-width:30px'> </div> <hr> <div class='form-row'> 
...
style='margin-top:4px'><i class='fa fa-plus'></i> <span data-i18n='opcua-iiot-contrib.label.addButton'></span></a> 
 ...
 <h2>OPC UA IIoT Method Caller</h2> <p>The Node is to call a basic or complex method on the OPC UA server.</p> <h3>
Input</h3> <p>
