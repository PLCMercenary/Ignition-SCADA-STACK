...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Event', {
    ...
    oneditprepare: function () {
      ...
      eventTypeLookupField.click(function () {
        ...
        $.getJSON('/opcuaIIoT/plain/EvenTypeIds', function (data) {
...
for='node-input-name'><i class='icon-tag'></i> <span data-i18n='node-red:common.label.name'></span></label> <input 
...
data-i18n='opcua-iiot-contrib.label.usingListener'></span></label> <input type='checkbox' 
id='node-input-usingListener' style='max-width:30px'> </div> <hr> <div class='form-row'> <label 
...
payload (number/Object) <ul> <li>eventType (ObjectTypeId) </li><li>eventFilter (Array of conditions or events) <ul> 
<li>selectClause (Array) </li><li>whereClause (Object) </li></ul> </li><li>eventFields (Array) </li><li>
queueSize (counter) </li><li>interval (number msec.) <ul> <li>topic </li><li>nodetype (events) </li></ul> </li></ul>
</li></ul></div> <strong>Name</strong> <p>Name in the flow of Node-RED.</p> </script> 