...
RED.nodes.registerType("OPCUA-IIoT-Write",{category:"IIoT",color:"#ABCDEF",defaults:{connector:{type:"OPCUA-IIoT-Connector",required:!0},name:{value:""},justValue:{value:!0},showStatusActivities:{value:!1},showErrors:{value:!1}},inputs:1,outputs:1,align:"right",icon:"opcuaiiot.png",label:function(){return this.name||"Write"},labelStyle:function(){return this.name?"node_label_italic":""}})
...
</div> <hr> <div class='form-row'> <label style='min-width:160px' for='node-input-justValue'><i class='fa fa-th'></i> 
...
The Write node is for sending data to the OPC UA server. It handles a single data request and multiple data requests. All write requests will produce an array of StatusCodes for writing in amount as applied for and responded.
 ...
 to write values and datatypeName in the addressSpaceItems object is required.</p> <h3>Input</h3> <ul> <li>
payload (value to write one or all)</li> <li>topic</li> <li>addressSpaceItems or nodesToWrite (Array of Node-Ids) </li>
<li>nodetype (inject)</li> <li>injectType (write) </li><li>
