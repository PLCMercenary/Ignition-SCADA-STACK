...
class='icon-tag'></i> <span data-i18n='node-red:common.label.name'></span></label> <input type='text' 
id='node-input-name' placeholder='Name'> </div> <hr> <!-- <div class="form-row">
            ...
            </div> --> <div class='form-row'> <label style='min-width:160px' for='node-input-justValue'><i 
class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.justValue'></span></label> <input type='checkbox' 
id='node-input-justValue' style='max-width:30px'> </div> <div class='form-row'> <label style='min-width:160px' 
for='node-input-sendNodesToRead'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.sendNodesToRead'>
</span></label> <input type='checkbox' id='node-input-sendNodesToRead' style='max-width:30px'> </div> <div 
class='form-row'> <label style='min-width:160px' for='node-input-sendNodesToListener'><i class='fa fa-th'></i> <span 
...
id='node-input-sendNodesToBrowser' style='max-width:30px'> </div> <div class='form-row'> <label 
style='min-width:160px' for='node-input-singleBrowseResult'><i class='fa fa-th'></i> <span 
data-i18n='opcua-iiot-contrib.label.singleBrowseResult'></span></label> <input type='checkbox' 
id='node-input-singleBrowseResult' style='max-width:30px'> </div> <hr> <div class='form-row'> <label 
...
class='form-row'> <label for='node-input-nodeId'><i class='icon-search'></i> <span 
data-i18n='opcua-iiot-contrib.label.nodeId'></span></label> <input type='text' id='node-input-nodeId' 
style='width:40%' placeholder='ns=0;i=84'> <a id='node-lookup-nodeId' class='btn'><i id='node-lookup-topic-icon' 
class='fa fa-search'></i></a> <div> <span data-i18n='opcua-iiot-contrib.label.lookupUseHint'></span> </div> </div> 
</div> </div> <!-- TODO: ReferenceTypeIds List to add or remove reference types tp browse for --> </script> <script 
type='text/x-red' data-help-name='OPCUA-IIoT-Browser'> <h2>OPC UA IIoT Browser</h2> <p>
...
<div> <strong>Content of a subscribed message:</strong> <ul> <li>payload (value) <ul> <li>
browserItems (Array of Objects) </li><li>browserItemsCount </li><li>browseTopic (Browser root to browse) </li><li>
endpoint </li><li>session </li></ul> </li><li>topic </li><li>nodetype (browse) </li><li>injectType (inject) </li><li>
addressSpaceItems (Array of Objects to browse) </li><li>optional <ul> <li>nodesToRead (Array of String resluts) </li>
<li>nodesToReadCount </li><li>addressItemsToRead (Array of Object results) </li><li>addressItemsToReadCount </li><li>
addressItemsToBrowse (Array of Object results) </li><li>addressItemsToBrowseCount </li></ul> </li></ul> </div> <strong>
Name</strong> <p>Name in the flow of Node-RED.</p> <p>Set showErrors to get errors from node-opcua on browse.</p> 
</script> 