...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Server-ASO', {
    ...
    oneditprepare: function () {
      ...
      objecttypeLookupButton.click(function () {
      ...
      referencetypeLookupButton.click(function () {
...
placeholder='ns=2;s=MySwitch or ns=2;i=1234'> </div> <div class='form-row'> <label for='node-input-browsename'><i 
...
</span></label> <input type='text' id='node-input-referenceNodeId' placeholder='ns=2;s=MySwitch or ns=2;i=1234'> </div>
...
class='fa fa-search'></i></a> </div> <hr> <div class='form-row'> <label for='node-input-name'><i class='icon-tag'></i> 
