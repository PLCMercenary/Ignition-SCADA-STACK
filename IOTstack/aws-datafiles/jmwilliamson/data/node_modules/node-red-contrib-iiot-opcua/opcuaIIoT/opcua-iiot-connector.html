...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Connector', {
    ...
    defaults: {
      ...
      endpointMustExist: {value: true},
      autoSelectRightEndpoint: {value: true},
    ...
    oneditprepare: function () {
      ...
      discoveryLookupButton.click(function () {
      ...
      endpointsLookupButton.click(function () {
...
class='form-row'> <label style='min-width:160px' for='node-config-input-endpointMustExist'><i 
class='fa fa-cc-discover'></i> <span data-i18n='opcua-iiot-contrib.label.endpointMustExist'></span></label> <input 
type='checkbox' id='node-config-input-endpointMustExist' style='max-width:30px'> </div> <div class='form-row'> <label 
...
style='min-width:160px' for='node-config-input-showErrors'><i class='fa fa-th'></i> <span 
...
<option value='Basic128Rsa15'>Basic128Rsa15</option> <option value='Basic192'>Basic192</option> <option 
value='Basic192Rsa15'>Basic192Rsa15</option> <option value='Basic256'>Basic256</option> <option value='Basic256Rsa15'>
Basic256Rsa15</option> <option value='Basic256Sha256'>Basic256Sha256</option> </select> </div> <div class='form-row'> 
<!-- MessageSecurityMode enum via REST --> <label for='node-config-input-securityMode' style='min-width:140px'><i 
class='fa fa-key'></i> <span data-i18n='opcua-iiot-contrib.label.securityMode'></span></label> <select type='text' 
...
value='SIGNANDENCRYPT'>Sign&Encrypt</option> </select> </div> <div class='form-row'> <label style='min-width:140px'> <i
 class='fa fa-certificate'></i> <span data-i18n='opcua-iiot-contrib.label.certificateFiles'></span> </label> </div> 
...
style='min-width:480px'> </div> <div class='form-row'> <label for='node-config-input-defaultSecureTokenLifetime'><i 
class='fa fa-file'></i> <span data-i18n='opcua-iiot-contrib.label.defaultSecureTokenLifetime'></span></label> <input 
type='text' id='node-config-input-defaultSecureTokenLifetime' placeholder='60000'> &nbsp; msec. </div> <div 
class='form-row'> <label for='node-config-input-loginEnabled'><i class='icon-lock'></i> <span 
...
id='node-config-input-strategyMaxRetry' placeholder='200' style='width:80px'> </div> <div class='form-row'> <label 
...
id='node-config-input-strategyInitialDelay' placeholder='1000' style='width:80px'> &nbsp; msec. </div> <div 
...
class='form-row'> <label for='node-config-input-strategyRandomisationFactor'><i class='fa fa-clock-o'></i> <span 
data-i18n='opcua-iiot-contrib.label.strategyRandomisationFactor'></span></label> <input type='text' 
id='node-config-input-strategyRandomisationFactor' placeholder='0.1' style='width:80px'> </div> <hr> <h4>Session</h4> 
...
</div> </script> <script type='text/x-red' data-help-name='OPCUA-IIoT-Connector'> <h2>OPC UA IIoT Connector</h2> <p>
The Connector is a pure configuration node and starts connecting to the OPC UA server with an OPC UA client instantly after 'Deploy' or start/restart. Please, keep in mind that the Connector node will work if it is unused and open a connection to the endpoint, too.
</p> <p>
The best practice here is to delete unused Connectors or connect each Connector with the flow where it lives. That binding with the flow is to find in the right bottom corner of the Connectors configuration view. The default is 'On all flows' - set it to the flow to get all deleted if you delete the flow.
</p> <p>
...
<p>The endpoint must exist as named if that option is activated.</p> <p>
...
Basic128 </li><li>Basic128Rsa15 </li><li>Basic192 </li><li>Basic192Rsa15 </li><li>Basic256 </li><li>Basic256Rsa15 </li>
<li>Basic256Sha256 </li></ul> </div> <div> <ul style='margin-left:80px'> <li>None </li><li>Sign </li><li>Sign&Encrypt 
</li></ul> </div> <h3>Certificates</h3> <p>
...
</p> <p>With None/NONE mode the keys are not in use.</p> <h3>User Login</h3> <p>
