...
--> <script type='text/javascript'> RED.nodes.registerType('OPCUA-IIoT-Server', {
    ...
    oneditsave: function () {
      ...
      if (node.asoDemo === null || node.asoDemo === undefined) {
        asoDemo = true
      }
 ...
 <div class='form-row'> <ul style='background:#fff;min-width:600px;margin-bottom:20px' id='node-input-server-tabs'>
</ul> </div> <div id='node-input-server-tabs-content' style='min-height:170px'> <div 
id='opcuaiiot-server-tab-settings' style='display:none'> <div class='form-row'> <label for='node-input-port'><i 
class='fa fa-fort-awesom'></i> <span data-i18n='opcua-iiot-contrib.label.port'></span></label> 
...
for='node-input-endpoint'><i class='icon-tasks'></i> <span data-i18n='opcua-iiot-contrib.label.endpoint'></span>
</label> <input type='text' id='node-input-endpoint' placeholder='UA/NodeREDIIoTServer'> </div> <div class='form-row'> 
...
</span></label> <input type='text' id='node-input-maxNodesPerRead' placeholder='10' style='width:80px'> </div> <div 
...
id='node-input-maxNodesPerBrowse' placeholder='10' style='width:80px'> </div> <hr> <div class='form-row'> <label 
...
id='node-input-alternateHostname' placeholder=''> </div> <div class='form-row'> <label for='node-input-name'><i 
class='fa fa-tag'></i> <span data-i18n='node-red:common.label.name'></span></label> <input type='text' 
id='node-input-name' placeholder=''> </div> <hr> <div class='form-row'> <label style='min-width:160px' 
for='node-input-isAuditing'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.isAuditing'></span>
</label> <input type='checkbox' id='node-input-isAuditing' style='max-width:30px'> </div> <div class='form-row'> <label
 style='min-width:160px' for='node-input-asoDemo'><i class='fa fa-th'></i> <span 
data-i18n='opcua-iiot-contrib.label.asoDemo'></span></label> <input type='checkbox' id='node-input-asoDemo' 
style='max-width:30px'> </div> <hr> <div class='form-row'> <label style='min-width:160px' 
for='node-input-showStatusActivities'><i class='fa fa-th'></i> <span 
...
style='max-width:30px'> </div> </div> <div id='opcuaiiot-server-tab-security' style='display:none'> <div 
class='form-row'> <!-- SecurityPolicy enum via REST --> <label for='node-input-securityPolicy' style='min-width:140px'>
<i class='fa fa-certificate'></i> <span data-i18n='opcua-iiot-contrib.label.securityPolicy'></span></label> <ul 
style='margin-left:80px'> <li>None</li> <li>Basic128</li> <li>Basic128Rsa15</li> <li>Basic192</li> <li>Basic192Rsa15
</li> <li>Basic256</li> <li>Basic256Rsa15</li> <li>Basic256Sha256</li> </ul> </div> <div class='form-row'> 
...
</span> </label> </div> <div class='form-row'> <label for='node-input-publicCertificateFile'><i class='fa fa-file'></i>
 <span data-i18n='opcua-iiot-contrib.label.publicCertificateFile'></span></label> <input type='text' 
id='node-input-publicCertificateFile' placeholder='./certificates/server_selfsigned_cert_2048.pem' 
style='min-width:480px'> </div> <div class='form-row'> <label for='node-input-privateCertificateFile'><i 
...
style='min-width:480px'> </div> <div class='form-row'> <label for='node-input-allowAnonymous' style='min-width:140px'>
<i class='icon-lock'></i> <span data-i18n='opcua-iiot-contrib.label.allowAnonymous'></span></label> <input 
type='checkbox' id='node-input-allowAnonymous' style='max-width:35px'> </div> <div class='form-row'> <label 
for='node-input-serverDiscovery' style='min-width:140px'><i class='fa fa-cc-discover'></i> <span 
data-i18n='opcua-iiot-contrib.label.serverDiscovery'></span></label> <input type='checkbox' 
id='node-input-serverDiscovery' style='max-width:35px'> </div> </div> <div id='opcuaiiot-server-tab-users' 
style='display:none'> <h4><span data-i18n='opcua-iiot-contrib.label.users'></span></h4> <div 
class='form-row node-input-server-users-container-row' style='margin-bottom:0'> <div 
...
data-i18n='opcua-iiot-contrib.label.xmlsets'></span></h4> <div 
class='form-row node-input-server-xmlsets-container-row' style='margin-bottom:0'> <div 
id='node-input-server-xmlsets-container-div' 
...
</div> </div> </div> </script> <script type='text/x-red' data-help-name='OPCUA-IIoT-Server'>
 <h2>OPC UA IIoT Server</h2> <p>
The Server node is an OPC UA server with a small information model. The address space is to expand with the ASO nodes and commands are to send by the Command nodes.
</p> <p>Default enpoint: opc.tcp://localhost:55388</p> <p>Named enpoint: opc.tcp://localhost:55388/UA/NodeREDIIoTServer
</p> <p>Default discovery: opc.tcp://localhost:4840/UADiscovery</p> <p>all discovery: opc.tcp://localhost:4840/</p> <p>
