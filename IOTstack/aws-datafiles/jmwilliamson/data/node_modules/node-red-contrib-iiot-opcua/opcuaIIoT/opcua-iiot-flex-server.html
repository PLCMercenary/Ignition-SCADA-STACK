...
</label> <input type='text' id='node-input-endpoint' placeholder='UA/NodeREDFlexIIoTServer'> </div> <div 
class='form-row'> <label for='node-input-maxAllowedSessionNumber'><i class='icon-list'></i> <span 
...
id='node-input-name' placeholder=''> </div> <div class='form-row'> <label style='min-width:160px' 
for='node-input-isAuditing'><i class='fa fa-th'></i> <span data-i18n='opcua-iiot-contrib.label.isAuditing'></span>
</label> <input type='checkbox' id='node-input-isAuditing' style='max-width:30px'> </div> <hr> <div class='form-row'> 
...
</div> <div class='form-row node-text-editor-row' id='div-script-editor'> <div style='height:350px;min-height:150px' 
class='node-text-editor' id='node-input-func-editor-addressSpaceScript'></div> </div> </div> </div> </script> <script 
type='text/x-red' data-help-name='OPCUA-IIoT-Flex-Server'> <h2>OPC UA IIoT Flex Server</h2> <p>
...
Default discovery: opc.tcp://localhost:4840/UAFlexDiscovery</p> <p>all discovery: opc.tcp://localhost:4840/</p> <p>
